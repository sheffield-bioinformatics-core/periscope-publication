...
sg = read.csv("supplementary_file_f1_cannonical_orf_counts.csv")

# We exclude ORF1a as it does not produce sgRNA and N* which is the non-canonical sgRNA produced in KR mutants
...
m$location="SHEF"
glasgow = read.csv("supplementary_file_f7_glasgow_ont.csv")
...
cell_illumina = read.csv("supplementary_file_f5_illumina_in_vitro.csv")
...
cell_ont = read.csv("supplementary_file_f6_ont_in_vitro.csv")
...
rep=read.table("supplementary_file_f4_repeats.csv",sep=",",header=T)
...
y=log10(11000)
down=read.csv("supplementary_file_f3_downsampling.csv")
...
g = ggpairs(spread_down
        ,columns=c(3,4,5,6,7,8),xlab="sgRPTg (High Quality - Log10)",ylab="sgRPTg (High Quality - Log10)",legend = c(2,1) ,lower = list(mapping = aes(color = orf),continuous = add_stat_smooth,axisLabels = "show"),diag  = list(continuous = "blankDiag"),upper  = list(continuous = "blank"))+
  ft_theme()+
  scale_x_continuous("sgRPTg High Quality (Log10)",trans=scales::pseudo_log_trans(base = 10),breaks=c(0,10,100,1000,10000))+
  scale_y_continuous("sgRPTg High Quality (Log10)",trans=scales::pseudo_log_trans(base = 10),breaks=c(0,10,100,1000,10000))+
  theme(panel.background=element_rect(fill="grey97",color="white"),
...
# Run information
runs=read.csv("supplementary_file_f8_sample_run_info.csv")

# CT Values
ct = read.csv("supplementary_file_f9_sample_ect.csv")
...
setwd("summary_data/")
novel_glas=read.csv("supplementary_file_f10_novel_orf_counts_glasgow.csv")
...
novel_shef=read.csv("supplementary_file_f2_novel_orf_counts.csv")
...
novel_glasgow_bait = read.csv("supplementary_file_f11_glasgow_bait_capure_novel.csv")
...
setwd("summary_data")
novel = read.csv("supplementary_file_f12_illumina_in_vitro_novel.csv")
...
novel_ont = read.csv("supplementary_file_f13_ont_in_vitro_novel.csv")
novel_ont$y=0.05
...
variants=read.table("supplementary_file_f16_base_counts.csv",sep=",",header=T)
...
setwd("summary_data")
read_lengths=read.csv("supplementary_file_f15_read_lengths.csv",sep="\t")
...
shef = read.csv("supplementary_file_f1_cannonical_orf_counts.csv")

shef_mapped_reads = unique(shef %>% select(sample,mapped_reads) )
shef_mapped_reads$location = "SHEF"
glas = read.csv("supplementary_file_f7_glasgow_ont.csv")
...
shef_canonical_ont = read.csv("supplementary_file_f1_cannonical_orf_counts.csv")
...
glas_canonical_ont = read.csv("supplementary_file_f7_glasgow_ont.csv")
...
glas_non_canonical_ont=read.csv("supplementary_file_f10_novel_orf_counts_glasgow.csv")
...
shef_non_canonical_ont=read.csv("supplementary_file_f2_novel_orf_counts.csv")
...
non_canonical_illumina = read.csv("supplementary_file_f11_glasgow_bait_capure_novel.csv")
...
canonical_illumina = read.csv("supplementary_file_f14_glasgow_bait_capure.csv")
...
cell_canonical_ont = read.csv("supplementary_file_f6_ont_in_vitro.csv")
...
cell_non_canonical_ont = read.csv("supplementary_file_f13_ont_in_vitro_novel.csv")
...
cell_canonical_illumina = read.csv("supplementary_file_f5_illumina_in_vitro.csv")
...
cell_non_canonical_illumina = read.csv("supplementary_file_f12_illumina_in_vitro_novel.csv")
...
#### Supplementary Figure S6 -  Number of samples with at the most frequently represented non-canonical sub-genomic RNAs
...
#### Supplementary Figure S7 - Read-Level evidence for non-canonical sub-genomic RNA at 5785 and 10639
...
bait = read.csv("supplementary_file_f14_glasgow_bait_capure.csv")
# 
...
novel_illunima = read.csv("supplementary_file_f11_glasgow_bait_capure_novel.csv")
...
#### Supplementary Figure S9 - Non-canonical sub-genomic RNA detected in an vitro infection model
...
#### Supplementary Figure S13 - Normalised ECT and Consensus coverage are not Correlated with the Raw amount of Sub-Genomic RNA Detected
...
coverage = read.table("supplementary_file_f17_coverage.csv",sep=",",header=T,fill=T)
